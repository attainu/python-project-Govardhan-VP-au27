from t_Players import TurnPlayers
...
class PlayGame:
    def play_single_player_game(num_of_players, players_names):
        ...
        # THIS CODE WILL EXECUTE IF ONLY ONE PLAYER WANT TO PLAY THE GAME
        game_over = False
        while not game_over:
    ...
    # THIS CODE WILL EXECUTE IN CASE IF NUMBER OF PLAYERS ARE MORE THAN ONE
